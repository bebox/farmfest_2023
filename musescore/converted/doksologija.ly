...
%% <- /museScore/Score/metaTag
%% -> /museScore/Score/metaTag text="2023-06-27" attr="{'name': 'creationDate'}"
%% <- /museScore/Score/metaTag
...
%% -> /museScore/Score/Part/trackName text="Piano, Piano, Organ"
%% <- /museScore/Score/Part/trackName
%% -> /museScore/Score/Part/Instrument attr="{'id': 'piano'}"
%% -> /museScore/Score/Part/Instrument/longName text="Piano, Piano, Organ"
...
%% VBox(style='Title', text='Doksologija')
%% -> /museScore/Score/Staff/VBox/Text/style text="Title"
%% <- /museScore/Score/Staff/VBox/Text/style
%% -> /museScore/Score/Staff/VBox/Text/text text="Doksologija"
%% <- /museScore/Score/Staff/VBox/Text/text
%% <- /museScore/Score/Staff/VBox/Text
%% -> /museScore/Score/Staff/VBox/Text
%% VBox(style='Composer', text='Genevan Psalter')
%% -> /museScore/Score/Staff/VBox/Text/style text="Composer"
%% <- /museScore/Score/Staff/VBox/Text/style
%% -> /museScore/Score/Staff/VBox/Text/text text="Genevan Psalter"
%% <- /museScore/Score/Staff/VBox/Text/text
%% <- /museScore/Score/Staff/VBox/Text
%% <- /museScore/Score/Staff/VBox
...
%% Tempo(tempo='1.8333333333333333', text='\ueca5', text_sym='')
%% -> /museScore/Score/Staff/Measure/voice/Tempo/tempo text="1.8333333333333333"
%% <- /museScore/Score/Staff/Measure/voice/Tempo/tempo
%% -> /museScore/Score/Staff/Measure/voice/Tempo/offset attr="{'x': '-5.51613', 'y': '-4.16935'}"
...
%% -> /museScore/Score/Staff/Measure/voice/Tempo/text/b text="= 90"
...
%% Harmony(root='10', root_case='', name='', base='')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="10"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% <- /museScore/Score/Staff/Measure/voice/Harmony
%% -> /museScore/Score/Staff/Measure/voice/Chord
%% Chord(duration_type='half', note_pitch='68', note_tpc='10', dots='')
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='Sva', syllabic='', ticks='', ticks_f='', no='1')
...
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/tpc text="10"
...
%% <- /museScore/Score/Staff/Measure/voice/Chord
%% -> /museScore/Score/Staff/Measure/voice/Chord
%% Chord(duration_type='quarter', note_pitch='68', note_tpc='10', dots='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/durationType text="quarter"
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='vi', syllabic='end', ticks='', ticks_f='0/16', no='')
...
%% <- /museScore/Score/Staff/Measure/voice/Chord
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='11', root_case='', name='', base='15')
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='mo', syllabic='', ticks='', ticks_f='', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="mo"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='va', syllabic='end', ticks='', ticks_f='0/16', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
...
%% -> /museScore/Score/Staff/Measure/voice
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='13', root_case='', name='m7', base='')
...
%% <- /museScore/Score/Staff/Measure/voice/Chord
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='13', root_case='', name='m7', base='11')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="13"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% -> /museScore/Score/Staff/Measure/voice/Harmony/name text="m7"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/name
%% -> /museScore/Score/Staff/Measure/voice/Harmony/base text="11"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/base
%% <- /museScore/Score/Staff/Measure/voice/Harmony
%% -> /museScore/Score/Staff/Measure/voice/Chord
%% Chord(duration_type='quarter', note_pitch='63', note_tpc='11', dots='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/durationType text="quarter"
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='smom', syllabic='end', ticks='', ticks_f='0/16', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f text="0/16"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="smom"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
...
%% <- /museScore/Score/Staff/Measure/voice/Chord
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='10', root_case='', name='7', base='14')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="10"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
...
%% -> /museScore/Score/Staff/Measure/voice
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='9', root_case='', name='m6', base='')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="9"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% -> /museScore/Score/Staff/Measure/voice/Harmony/name text="m6"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/name
%% <- /museScore/Score/Staff/Measure/voice/Harmony
%% -> /museScore/Score/Staff/Measure/voice/Chord
%% Chord(duration_type='half', note_pitch='70', note_tpc='12', dots='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/durationType text="half"
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='ga', syllabic='end', ticks='', ticks_f='0/16', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f text="0/16"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='be', syllabic='middle', ticks='', ticks_f='', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
...
%% <- /museScore/Score/Staff/Measure/voice/Chord
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='10', root_case='', name='', base='11')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="10"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% -> /museScore/Score/Staff/Measure/voice/Harmony/base text="11"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/base
%% <- /museScore/Score/Staff/Measure/voice/Harmony
%% -> /museScore/Score/Staff/Measure/voice/Chord
%% Chord(duration_type='half', note_pitch='72', note_tpc='14', dots='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/durationType text="half"
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='skom.', syllabic='end', ticks='', ticks_f='0/16', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f text="0/16"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="skom."
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='Svet,', syllabic='', ticks='', ticks_f='', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="Svet,"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='Si', syllabic='begin', ticks='', ticks_f='', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="begin"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='nu', syllabic='end', ticks='', ticks_f='0/16', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
...
%% -> /museScore/Score/Staff/Measure/voice
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='18', root_case='', name='dim7', base='')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="18"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% -> /museScore/Score/Staff/Measure/voice/Harmony/name text="dim7"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/name
%% <- /museScore/Score/Staff/Measure/voice/Harmony
%% -> /museScore/Score/Staff/Measure/voice/Chord
%% Chord(duration_type='quarter', note_pitch='70', note_tpc='12', dots='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/durationType text="quarter"
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='vječ', syllabic='begin', ticks='', ticks_f='', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="begin"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="vječ"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
...
%% <- /museScore/Score/Staff/Measure/voice/Chord
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='13', root_case='', name='m7(11)', base='')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="13"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% -> /museScore/Score/Staff/Measure/voice/Harmony/name text="m7(11)"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/name
%% <- /museScore/Score/Staff/Measure/voice/Harmony
%% -> /museScore/Score/Staff/Measure/voice/Chord
%% Chord(duration_type='quarter', note_pitch='68', note_tpc='10', dots='')
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='hu', syllabic='end', ticks='', ticks_f='0/16', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f text="0/16"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="hu"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/pitch text="68"
...
%% <- /museScore/Score/Staff/Measure/voice/Chord
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='12', root_case='', name='m7(11)', base='')
...
%% <- /museScore/Score/Staff/Measure/voice/Harmony
%% -> /museScore/Score/Staff/Measure/voice/Chord
%% Chord(duration_type='half', note_pitch='73', note_tpc='9', dots='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/durationType text="half"
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Note/pitch
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/tpc text="9"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Note/tpc
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/velocity text="100"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Note/velocity
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/veloType text="user"
...
%% -> /museScore/Score/Staff/Measure/voice
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='12', root_case='', name='7', base='')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="12"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% -> /museScore/Score/Staff/Measure/voice/Harmony/name text="7"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/name
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='spod', syllabic='end', ticks='', ticks_f='0/16', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f text="0/16"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='sve', syllabic='middle', ticks='', ticks_f='', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="middle"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
...
%% <- /museScore/Score/Staff/Measure/voice/Chord
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='9', root_case='', name='6', base='11')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="9"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% -> /museScore/Score/Staff/Measure/voice/Harmony/name text="6"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/name
%% -> /museScore/Score/Staff/Measure/voice/Harmony/base text="11"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/base
%% <- /museScore/Score/Staff/Measure/voice/Harmony
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='Bog!', syllabic='', ticks='', ticks_f='', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="Bog!"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='tom.', syllabic='end', ticks='', ticks_f='', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="tom."
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/pitch text="70"
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='Tro', syllabic='begin', ticks='', ticks_f='', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="begin"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="Tro"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/pitch text="68"
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='ka', syllabic='end', ticks='', ticks_f='0/16', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f text="0/16"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='je', syllabic='middle', ticks='', ticks_f='', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="middle"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='nam', syllabic='', ticks='', ticks_f='', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="nam"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='di', syllabic='middle', ticks='', ticks_f='', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="middle"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
...
%% -> /museScore/Score/Staff/Measure/voice
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='8', root_case='', name='Maj9', base='10')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="8"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% -> /museScore/Score/Staff/Measure/voice/Harmony/name text="Maj9"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/name
%% -> /museScore/Score/Staff/Measure/voice/Harmony/base text="10"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/base
%% <- /museScore/Score/Staff/Measure/voice/Harmony
%% -> /museScore/Score/Staff/Measure/voice/Chord
%% Chord(duration_type='quarter', note_pitch='70', note_tpc='12', dots='')
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='no', syllabic='middle', ticks='', ticks_f='', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="middle"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='dost', syllabic='end', ticks='', ticks_f='0/16', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f text="0/16"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='me', syllabic='end', ticks='', ticks_f='0/16', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
...
%% <- /museScore/Score/Staff/Measure/voice/Chord
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='9', root_case='', name='', base='')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="9"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% <- /museScore/Score/Staff/Measure/voice/Harmony
%% -> /museScore/Score/Staff/Measure/voice/Chord
%% Chord(duration_type='half', note_pitch='65', note_tpc='13', dots='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/durationType text="half"
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
...
%% -> /museScore/Score/Staff/Measure/voice
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='14', root_case='', name='7(b9)', base='')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="14"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% -> /museScore/Score/Staff/Measure/voice/Harmony/name text="7(b9)"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/name
%% <- /museScore/Score/Staff/Measure/voice/Harmony
%% -> /museScore/Score/Staff/Measure/voice/Chord
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='gu', syllabic='end', ticks='', ticks_f='0/16', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='ne.', syllabic='end', ticks='', ticks_f='0/16', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f text="0/16"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
...
%% -> /museScore/Score/Staff/Measure/voice
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='10', root_case='', name='', base='14')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="10"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% -> /museScore/Score/Staff/Measure/voice/Harmony/base text="14"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/base
%% <- /museScore/Score/Staff/Measure/voice/Harmony
%% -> /museScore/Score/Staff/Measure/voice/Chord
%% Chord(duration_type='half', note_pitch='75', note_tpc='11', dots='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/durationType text="half"
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='Pje', syllabic='begin', ticks='', ticks_f='', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="begin"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='vaj', syllabic='end', ticks='', ticks_f='0/16', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f text="0/16"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="vaj"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/pitch text="72"
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='vot', syllabic='end', ticks='', ticks_f='0/16', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f text="0/16"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='mo', syllabic='', ticks='', ticks_f='', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="mo"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
...
%% -> /museScore/Score/Staff/Measure/voice
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='12', root_case='', name='m', base='')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="12"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='naš', syllabic='', ticks='', ticks_f='', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="naš"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='du', syllabic='begin', ticks='', ticks_f='', no='1')
...
%% <- /museScore/Score/Staff/Measure/voice/Chord
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='12', root_case='', name='0', base='')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="12"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% -> /museScore/Score/Staff/Measure/voice/Harmony/name text="0"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/name
%% <- /museScore/Score/Staff/Measure/voice/Harmony
%% -> /museScore/Score/Staff/Measure/voice/Chord
%% Chord(duration_type='quarter', note_pitch='73', note_tpc='9', dots='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/durationType text="quarter"
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='šom', syllabic='end', ticks='', ticks_f='0/16', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f text="0/16"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="šom"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/pitch text="73"
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='za', syllabic='begin', ticks='', ticks_f='', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="begin"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
...
%% <- /museScore/Score/Staff/Measure/voice/location
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='16', root_case='', name='0', base='')
...
%% -> /museScore/Score/Staff/Measure/voice
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='12', root_case='', name='m7(11)', base='11')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="12"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% -> /museScore/Score/Staff/Measure/voice/Harmony/name text="m7(11)"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/name
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='hval', syllabic='middle', ticks='', ticks_f='', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="middle"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="hval"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/pitch text="70"
...
%% <- /museScore/Score/Staff/Measure/voice/location
%% -> /museScore/Score/Staff/Measure/voice/Harmony
%% Harmony(root='11', root_case='', name='7', base='')
%% -> /museScore/Score/Staff/Measure/voice/Harmony/root text="11"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/root
%% -> /museScore/Score/Staff/Measure/voice/Harmony/name text="7"
%% <- /museScore/Score/Staff/Measure/voice/Harmony/name
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='nom.', syllabic='end', ticks='', ticks_f='0/16', no='1')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no text="1"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/no
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f text="0/16"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/ticks_f
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="nom."
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/pitch text="68"
...
%% <- /museScore/Score/Staff/Measure/voice/Harmony
%% -> /museScore/Score/Staff/Measure/voice/Chord
%% Chord(duration_type='whole', note_pitch='68', note_tpc='10', dots='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/durationType text="whole"
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='A', syllabic='begin', ticks='', ticks_f='', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="begin"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
...
%% <- /museScore/Score/Staff/Measure/voice/Chord/durationType
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% Lyrics(text='men!', syllabic='end', ticks='', ticks_f='', no='')
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic text="end"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/syllabic
%% -> /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text text="men!"
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics/text
%% <- /museScore/Score/Staff/Measure/voice/Chord/Lyrics
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note
%% -> /museScore/Score/Staff/Measure/voice/Chord/Note/pitch text="68"
